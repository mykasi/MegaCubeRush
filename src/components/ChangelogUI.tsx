...
const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    ...
    date: '2026/05/23',
    items: [
      'メタプログレッションに「装備レベル制限緩和」（最大Lv.8）を新規実装',
      'ヘルプのステータス項目に「プレイヤーLv」および「アイテムLv」の情報を追加',
      '遠隔武器4種（ハンドガン・サブマシンガン・ライフル・ショットガン）の射程と弾速を調整',
      'ゲーム進行と表示時間でズレが発生していた不具合を修正',
      'メタプログレッション「オーバーロード」のレベルを上げた状態でのラスボス戦において、破壊したコアやシールドが復活することがあった不具合を修正',
    ]
  },
  {
    version: 'Ver.1.4.0',
