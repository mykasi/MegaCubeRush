...
export const UPGRADE_ITEMS: UpgradeDef[] = [
  ...
  { id: 'up_ob', name: 'OBゲージ', desc: '最大値+10%', maxLevel: 10, currency: 'energy', baseCost: 40000 },
  { id: 'up_ar', name: 'ARゲージ', desc: '最大値+10%', maxLevel: 10, currency: 'energy', baseCost: 40000 },
  ...
  { id: 'up_enc_lightning', name: '雷属性エンチャント', desc: 'ゲーム開始時から雷属性エンチャントを所持(Lv+1)', maxLevel: 2, currency: 'hyper', baseCost: 1 },
